...
get_gefsdata <- function(date,member,fhour) {
  ...
  # sample url: https://noaa-gefs-pds.s3.amazonaws.com/gefs.20210919/00/atmos/pgrb2sp25/gec00.t00z.pgrb2s.0p25.f006
  
  url  = paste0("https://noaa-gefs-pds.s3.amazonaws.com/gefs.",YMD,"/00/atmos/pgrb2sp25/ge",member,".t00z.pgrb2s.0p25.f",fhour)
  
  outfile = paste0("archivos_2020_forward/GFSV12_",YMD,"_",member,"_",fhour,".grib2")
...
members  = c("c00",paste0("p",sprintf("%02d",seq(1,4)))) 
fhours   = sprintf("%03d",seq(9,201,3))
